import { n as useIndustry } from "./IndustryContext-BipHHbci.js";
import { n as useDashboardLayout, r as DASHBOARD_MODULES } from "./DashboardLayoutContext-ClhCll-G.js";
import { t as Shell } from "./Shell-DYfGwPs_.js";
import { a as TrendArrow, i as Dot, n as CardHeader, o as cn, r as Chip, t as Card } from "./primitives-BuKmOx9b.js";
import { _ as weekly, a as dayScore, c as forecast, d as pipelineRisks, f as recommendations, g as timeline, h as surfaces, i as briefing, l as kpis, m as sentiment, n as actions, o as deals, p as renewals, r as approvals, s as followUps, t as accountHealth, u as meetings } from "./mock-B6rfRqWa.js";
import * as React from "react";
import { Fragment, useEffect, useRef, useState } from "react";
import { Fragment as Fragment$1, jsx, jsxs } from "react/jsx-runtime";
import { ArrowDown, ArrowUp, Eye, EyeOff, GripVertical, RotateCcw, SlidersHorizontal } from "lucide-react";
import * as Dialog from "@radix-ui/react-dialog";
import * as SwitchPrimitives from "@radix-ui/react-switch";
//#region src/components/ProductTour.tsx
var STEPS = [
	{
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: "Lucent Tour" }), /* @__PURE__ */ jsxs("span", { children: [
						step + 1,
						" / ",
						STEPS.length
					] })]
...
//#endregion
//#region src/components/dashboard/SectionJump.tsx
...
//#endregion
//#region src/components/dashboard/ConnectorsPanel.tsx
var CONNECTORS = [
	{
		id: "salesforce",
		name: "Salesforce",
...
function statusChip(s) {
	if (s === "connected") return /* @__PURE__ */ jsx(Chip, {
		status: "healthy",
		children: "Connected"
	});
	if (s === "watch") return /* @__PURE__ */ jsx(Chip, {
		status: "watch",
		children: "Review"
	});
	return /* @__PURE__ */ jsx(Chip, { children: "Available" });
}
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [
			...
			/* @__PURE__ */ jsx("ul", {
				...
				children: visible.map((c) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
					type: "button",
...
var SheetOverlay = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(Dialog.Overlay, {
	ref,
...
var SheetContent = React.forwardRef(({ side = "right", className, children, ...props }, ref) => /* @__PURE__ */ jsxs(SheetPortal, { children: [/* @__PURE__ */ jsx(SheetOverlay, {}), /* @__PURE__ */ jsx(Dialog.Content, {
	ref,
...
var SheetTitle = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(Dialog.Title, {
	ref,
	className: cn("text-lg font-semibold text-foreground", className),
	...props
}));
SheetTitle.displayName = Dialog.Title.displayName;
var SheetDescription = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(Dialog.Description, {
	ref,
...
var Switch = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(SwitchPrimitives.Root, {
	...
	...props,
	children: /* @__PURE__ */ jsx(SwitchPrimitives.Thumb, { className: cn("pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg ring-0 transition-transform", "data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0") })
}));
Switch.displayName = SwitchPrimitives.Root.displayName;
//#endregion
//#region src/components/dashboard/CustomizePanel.tsx
...
function CustomizePanel() {
	...
	return /* @__PURE__ */ jsxs(Sheet, {
		...
		children: [/* @__PURE__ */ jsx(SheetTrigger, {
			...
			children: [
				/* @__PURE__ */ jsxs(SheetHeader, { children: [/* @__PURE__ */ jsx(SheetTitle, { children: "Customize dashboard" }), /* @__PURE__ */ jsxs(SheetDescription, { children: [
					"Toggle and reorder modules for the ",
					/* @__PURE__ */ jsx("b", { children: industry.name }),
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", { children: [allOrderedIds.length, " modules"] }), /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: reset,
					...
					children: allOrderedIds.map((id, index) => {
						...
						return /* @__PURE__ */ jsxs("li", {
							...
							children: [
								...
								meta.pinned ? /* @__PURE__ */ jsx(Eye, {
									className: "h-4 w-4 text-muted-foreground",
									"aria-label": "Always visible"
								}) : /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2",
									children: [visible ? /* @__PURE__ */ jsx(Eye, {
										className: "h-4 w-4 text-muted-foreground",
										"aria-hidden": "true"
									}) : /* @__PURE__ */ jsx(EyeOff, {
										className: "h-4 w-4 text-muted-foreground",
...
//#endregion
//#region src/components/dashboard/IndustryModules.tsx
function IndustryKpis() {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			right: /* @__PURE__ */ jsxs(Chip, {
				status: "primary",
				children: [industry.kpis.length, " metrics"]
			})
		}), /* @__PURE__ */ jsx("div", {
			className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3",
			children: industry.kpis.map((k) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { children: k.label }), k.flag ? /* @__PURE__ */ jsx(Dot, { status: k.flag }) : null]
					}),
					/* @__PURE__ */ jsx("div", {
						className: "mt-2 font-display text-3xl text-foreground",
						children: k.value
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(TrendArrow, { trend: k.trend }), /* @__PURE__ */ jsx("span", { children: k.delta })]
					})
				]
			}, k.label))
		})]
...
function IndustryModulesGrid() {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: industry.modules.map((mod) => /* @__PURE__ */ jsxs(Card, {
			id: mod.id,
			children: [/* @__PURE__ */ jsx(CardHeader, {
				title: mod.title,
				subtitle: mod.subtitle,
				right: /* @__PURE__ */ jsx(Chip, { children: mod.rows.length })
			}), /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
						...
						children: /* @__PURE__ */ jsx("tr", { children: mod.columns.map((c) => /* @__PURE__ */ jsx("th", {
							className: "px-3 py-2 text-left font-medium",
							children: c
						}, c)) })
					}), /* @__PURE__ */ jsx("tbody", { children: mod.rows.map((r, i) => /* @__PURE__ */ jsxs("tr", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("td", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2",
									children: [/* @__PURE__ */ jsx(Dot, { status: r.status }), /* @__PURE__ */ jsx("span", {
										className: "text-xs text-muted-foreground",
										children: r.note
									})]
								})
...
function IndustryPlaybooks() {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			className: "space-y-3",
			children: industry.playbooks.map((p) => /* @__PURE__ */ jsxs("li", {
...
//#endregion
//#region src/components/dashboard/sections.tsx
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "inline-block size-1.5 rounded-full bg-healthy" }), "Today · Strategic Pulse"]
				}),
				/* @__PURE__ */ jsxs("h1", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: dayScore.readiness.map((r) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: r.label
								}), /* @__PURE__ */ jsx(Dot, { status: r.status })]
							}), /* @__PURE__ */ jsx("div", {
...
function ActionRegister() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: actions.map((a) => /* @__PURE__ */ jsxs("li", {
				className: "flex items-center justify-between gap-3 py-3 first:pt-0 last:pb-0",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex min-w-0 items-center gap-3",
					children: [/* @__PURE__ */ jsx(Dot, { status: a.status }), /* @__PURE__ */ jsxs("div", {
						className: "min-w-0",
						children: [/* @__PURE__ */ jsx("div", {
...
function FollowUpAutopilot() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			right: /* @__PURE__ */ jsx(Chip, {
				status: "healthy",
				children: "All drafted"
			})
		}), /* @__PURE__ */ jsx("ul", {
			className: "space-y-3",
			children: followUps.map((f) => /* @__PURE__ */ jsxs("li", {
				className: "rounded-lg border border-border bg-surface-muted p-3",
				children: [
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", { children: ["Scheduled ", f.scheduled] }), /* @__PURE__ */ jsx("button", {
...
function MeetingToExecution() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			className: "space-y-3",
			children: meetings.map((m) => /* @__PURE__ */ jsxs("li", {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				children: [/* @__PURE__ */ jsx("thead", {
				...
				}), /* @__PURE__ */ jsx("tbody", { children: accountHealth.map((a) => /* @__PURE__ */ jsxs("tr", {
					...
					children: [
						/* @__PURE__ */ jsx("td", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx(Dot, { status: a.status }), /* @__PURE__ */ jsx("span", {
									className: "font-medium text-foreground",
									children: a.account
								})]
							})
...
function PipelineRiskRadar() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			className: "space-y-3",
			children: pipelineRisks.map((p) => /* @__PURE__ */ jsxs("li", {
				className: "flex items-start justify-between gap-3 rounded-lg border border-border bg-surface-muted p-3",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "min-w-0",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx(Dot, { status: p.risk }), /* @__PURE__ */ jsx("span", {
							className: "text-sm font-medium text-foreground",
							children: p.deal
						})]
					}), /* @__PURE__ */ jsxs("div", {
...
function ApprovalWorkflow() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			className: "divide-y divide-border",
			children: approvals.map((a) => /* @__PURE__ */ jsxs("li", {
				...
				return /* @__PURE__ */ jsxs("li", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(TrendArrow, { trend: s.trend }), Math.round(s.score * 100)]
						})]
					}), /* @__PURE__ */ jsx("div", {
...
function Recommendations() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: recommendations.map((r) => /* @__PURE__ */ jsxs("li", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", { children: ["Effort: ", r.effort] }), /* @__PURE__ */ jsx("button", {
							className: "font-medium text-primary hover:underline",
							children: "Run play →"
						})]
					})
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							className: "text-[11px] uppercase tracking-wider text-muted-foreground",
							children: k.label
						}), k.flag ? /* @__PURE__ */ jsx(Dot, { status: k.flag }) : null]
					}),
					/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						className: "mt-1 flex items-center gap-1 text-xs text-muted-foreground",
						children: [
							/* @__PURE__ */ jsx(TrendArrow, { trend: k.trend }),
							" ",
							k.delta
						]
					})
...
function CommunicationTimeline() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: timeline.map((t) => /* @__PURE__ */ jsxs("li", {
				className: "relative",
				children: [
					/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("span", { children: ["· ", t.account] })
						]
					}),
					/* @__PURE__ */ jsx("p", {
...
function RevenueForecast() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: forecast.map((f) => /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Dot, { status: "healthy" }),
					" On track (",
					onTrack.length,
					")"
				]
				...
				className: "space-y-2",
				children: onTrack.map((d) => /* @__PURE__ */ jsxs("li", {
					className: "rounded-lg border border-border bg-surface-muted p-3",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between",
						children: [/* @__PURE__ */ jsx("span", {
				...
				className: "space-y-2",
				children: stuck.map((d) => /* @__PURE__ */ jsxs("li", {
					className: "rounded-lg border border-border bg-surface-muted p-3",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between",
						children: [/* @__PURE__ */ jsx("span", {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: [
				...
				return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					className: "mb-2 flex items-center gap-2 text-xs uppercase tracking-wider text-muted-foreground",
					children: [
						/* @__PURE__ */ jsx(Dot, { status: g.status }),
						" ",
						g.label,
						" (",
						rows.length,
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [
			...
			/* @__PURE__ */ jsx("ul", {
				...
				children: briefing.bullets.map((b, i) => /* @__PURE__ */ jsxs("li", {
					className: "flex gap-3 text-sm text-foreground",
					children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 size-1.5 shrink-0 rounded-full bg-primary" }), /* @__PURE__ */ jsx("span", { children: b })]
				}, i))
			}),
			/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsx("tbody", { children: weekly.map((r) => {
...
function ProductReadiness() {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, {
			...
			children: surfaces.map((s) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", {
				href: s.href,
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Dot, { status: s.status }), /* @__PURE__ */ jsxs("div", {
						className: "min-w-0",
						children: [/* @__PURE__ */ jsx("div", {
							className: "truncate text-sm font-medium text-foreground",
							children: s.name
...
function renderModule(id) {
	switch (id) {
		case "hero": return /* @__PURE__ */ jsx(HeroSection, {});
		case "industry-kpis": return /* @__PURE__ */ jsx(IndustryKpis, {});
		case "industry-modules": return /* @__PURE__ */ jsx(IndustryModulesGrid, {});
		case "industry-playbooks": return /* @__PURE__ */ jsx(IndustryPlaybooks, {});
		case "connectors": return /* @__PURE__ */ jsx(ConnectorsPanel, {});
		case "briefing": return /* @__PURE__ */ jsx(BriefingPreview, {});
		case "actions": return /* @__PURE__ */ jsx(ActionRegister, {});
		case "followups": return /* @__PURE__ */ jsx(FollowUpAutopilot, {});
		case "meetings": return /* @__PURE__ */ jsx(MeetingToExecution, {});
		case "kpi": return /* @__PURE__ */ jsx(KpiDigest, {});
		case "forecast": return /* @__PURE__ */ jsx(RevenueForecast, {});
		case "pipeline-risk": return /* @__PURE__ */ jsx(PipelineRiskRadar, {});
		case "deals": return /* @__PURE__ */ jsx(DealProgression, {});
		case "health": return /* @__PURE__ */ jsx(CustomerHealthRadar, {});
		case "sentiment": return /* @__PURE__ */ jsx(EmailSentiment, {});
		case "recommendations": return /* @__PURE__ */ jsx(Recommendations, {});
		case "renewals": return /* @__PURE__ */ jsx(RenewalReminders, {});
		case "timeline": return /* @__PURE__ */ jsx(CommunicationTimeline, {});
		case "approvals": return /* @__PURE__ */ jsx(ApprovalWorkflow, {});
		case "weekly": return /* @__PURE__ */ jsx(WeeklyPerformanceTable, {});
		case "readiness": return /* @__PURE__ */ jsx(ProductReadiness, {});
		default: return null;
	}
}
function Dashboard() {
	...
	return /* @__PURE__ */ jsxs(Shell, { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					className: "min-w-0 flex-1",
					children: /* @__PURE__ */ jsx(SectionJump, { items: jumpItems.filter((i) => i.id !== heroId) })
				}), /* @__PURE__ */ jsx("div", {
					className: "shrink-0 pt-2",
					children: /* @__PURE__ */ jsx(CustomizePanel, {})
				})]
			}),
			rest.map((id) => /* @__PURE__ */ jsx(Fragment, { children: renderModule(id) }, id))
		]
	}), /* @__PURE__ */ jsx(ProductTour, {})] });
}
//#endregion
